          ...
          {selectedMenu === 'scrap' && (
            <>
              <div className="w-full">
                <div className="px-3 py-2 mt-5 mx-auto font-mixed text-2xl text-center text-shadow">
                  SPOT
                </div>
                {scrapedSpots.length > 0 && (
                  <div className="grid grid-cols-3 gap-5">
                    {scrapedSpots.slice(0, visibleSpotCount).map((spot) => (
                      <div key={spot.spotScrapId}>
                        <div className="relative mx-3">
                          ...
                          <BookmarkIcon
                            ...
                            onClick={(event) =>
                              handleSpotScrap(event, spot.spotId)
                            }
                          />
                        </div>
                        <div className="w-56 font-light truncate font-mixed text-md">
                          {spot.name}
                        </div>
                      </div>
                    ))}
